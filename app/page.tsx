...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-cream selection:bg-leaf-green/30">
      ...
      <section className="relative z-10 -mt-12 max-w-6xl mx-auto px-4">
        <div className="bg-white rounded-2xl shadow-xl border border-sage-light p-8 md:p-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={i} className="flex flex-col items-center">
              ...
              <p className="text-3xl font-serif font-bold text-jungle-dark">{stat.value}</p>
              <p className="text-xs uppercase tracking-widest text-gray-500 font-semibold mt-1">{stat.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="font-serif text-4xl md:text-5xl font-bold text-jungle-dark mt-4 mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="group p-8 rounded-3xl bg-white border border-transparent hover:border-leaf-green/20 hover:shadow-2xl transition-all duration-500">
            <div className="w-14 h-14 bg-sage-light rounded-2xl flex items-center justify-center mb-6 group-hover:bg-leaf-green transition-colors duration-500">
              <Compass className="text-leaf-green group-hover:text-white transition-colors" />
            </div>
            <h3 className="text-xl font-bold text-jungle-dark mb-4">Tailor-Made Design</h3>
          ...
          <div className="group p-8 rounded-3xl bg-white border border-transparent hover:border-leaf-green/20 hover:shadow-2xl transition-all duration-500">
            ...
            <h3 className="text-xl font-bold text-jungle-dark mb-4">Local Heritage</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="group p-8 rounded-3xl bg-white border border-transparent hover:border-leaf-green/20 hover:shadow-2xl transition-all duration-500">
            ...
            <h3 className="text-xl font-bold text-jungle-dark mb-4">Carbon Neutral</h3>
            <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/3 h-full bg-sage-light/30 -skew-x-12 transform translate-x-20" />
        <div className="max-w-5xl mx-auto relative z-10 flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-jungle-dark mb-8 leading-tight">
          ...
          <div className="flex-1 w-full max-w-md">
            <div className="aspect-square bg-white rounded-[40px] shadow-2xl p-4 rotate-3 hover:rotate-0 transition-transform duration-700">
              <div className="w-full h-full bg-sage-light rounded-4xl flex items-center justify-center p-8 text-center border-2 border-dashed border-leaf-green/30">
                <div className="space-y-4">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto shadow-lg">
                    <Compass className="w-8 h-8 text-leaf-green" />
                  </div>
                  <p className="font-bold text-jungle-dark text-xl italic font-serif">Your custom plan is waiting.</p>
                </div>
              </div>
            </div>
          </div>
