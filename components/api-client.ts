...
const PRESETS = {
  ...
  footerLinks: [
    { _id: 'fl1', title: 'Safari Apparel', url: '/shop#safari-apparel', category: 'shop', order: 1 },
    { _id: 'fl2', title: 'Travel Accessories', url: '/shop#travel-accessories', category: 'shop', order: 2 },
